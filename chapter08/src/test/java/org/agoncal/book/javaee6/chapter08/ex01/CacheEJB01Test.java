package org.agoncal.book.javaee6.chapter08.ex01;
...
public class CacheEJB01Test {
    ...
    public void shouldAddRemoveAndGetThingsFromTheCache() throws Exception {
        ...
        // Looks up the EJB
        CacheEJB01 cacheEJB = (CacheEJB01) ctx.lookup("java:global/classes/CacheEJB01!org.agoncal.book.javaee6.chapter08.ex01.CacheEJB01");
